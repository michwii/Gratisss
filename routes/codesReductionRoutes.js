...
var codesReductionRoute = express.Router();


codesReductionRoute.get('/api/codes-de-reduction', function(req, res){
...
codesReductionRoute.get('/api/codes-de-reduction/:id', function(req, res){
	res.setHeader('Content-Type', 'application/json');
...
codesReductionRoute.post('/api/codes-de-reduction', function(req, res){
	res.setHeader('Content-Type', 'application/json');
...
codesReductionRoute.delete('/api/codes-de-reduction/:id', function(req, res){
	res.setHeader('Content-Type', 'application/json');
	var id = req.params.id;
...
codesReductionRoute.get('/codes-de-reduction', function(req, res){
...
module.exports = codesReductionRoute;